...
function compute_bal_part(price_DA, price_bal, system, delta_less, delta_more, t, w)
...
function step_1_2(in_sample_scen, prob, P_nom, p_real, price_DA, system, price_bal)
    ...
    @objective(model, Max, sum(prob .* sum(price_DA[t,w].*p_DA[t] + compute_bal_part(price_DA, price_bal, system, delta_less, delta_more, t, w)    
    ...
    #     bal_revenue[t,w] = value.(compute_bal_part(price_DA, price_bal, system, delta_less, delta_more, t, w))
    # end 
