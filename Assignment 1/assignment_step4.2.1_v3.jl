...
# Constraints
@constraint(model_step2, cst_demands[d in demands], load_demands[d] <= max_load_demands[d])
@constraint(model_step2, cst_suppliers[s in suppliers], power_suppliers[s] <= max_power_suppliers[s])
